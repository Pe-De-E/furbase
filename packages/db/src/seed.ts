...
async function main() {
  ...
  await db.insert(schema.animalTag).values([
    ...
    { animalId: animalByName['Kiwi'],   tagId: tagByName['good with kids'] },
    { animalId: animalByName['Keks'],   tagId: tagByName['good with kids'] },
    { animalId: animalByName['Stachel'],tagId: tagByName['experienced owner'] },
  ])
